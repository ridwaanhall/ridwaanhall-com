...
This repo does not auto-hash its compiled CSS filename. The output path is a hand-picked string (currently `staticfiles/css/global-fnrmrtud.css`) that is hardcoded in three places, which must always agree:
