...
The compiled Tailwind output filename (currently `global-bijbtigg.css`) is a hand-picked string, not an auto-generated hash. It's hardcoded in three places that must stay in sync:
