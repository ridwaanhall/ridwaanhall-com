...
npx @tailwindcss/cli -i ./static/css/input.css -o ./staticfiles/css/global-mxjrvdft.css --watch
...
npx @tailwindcss/cli -i ./static/css/input.css -o ./staticfiles/css/global-mxjrvdft.css --watch --minify

# Production build
npx @tailwindcss/cli -i ./static/css/input.css -o ./staticfiles/css/global-mxjrvdft.css --minify
```
...
> **Note:** the compiled filename (`global-mxjrvdft.css`) is hand-picked, not auto-hashed. If you rename it, update the `-o` path above **and** the `{% static %}` reference in both `templates/base_seo.html` and `templates/error.html`.
