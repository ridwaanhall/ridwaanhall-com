...
class AboutData:
    ...
    def get_about_data(cls) -> dict:
        ...
        instance = AboutDataModel(
            ...
            stories=[
                "I am Ridwan, known as ridwaanhall. A Python developer with hands-on experience in machine learning and web development based in Boyolali, Indonesia. I lead RoneAI, my creative hub for building intelligent systems and web applications with Django, Flask, and ML tools with PyTorch and TensorFlow.",
