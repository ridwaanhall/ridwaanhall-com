...
class AboutData:
    ...
    def get_about_data(cls) -> dict:
        ...
        instance = AboutDataModel(
            ...
            stories=[
                "I am Ridwan, known as ridwaanhall or roneha. A Python developer with hands-on experience in machine learning and web development based in Boyolali, Indonesia. I lead RoneAI, my creative hub for building intelligent systems and web applications with Django, Flask, and ML tools with PyTorch and TensorFlow.",
                "During my latest internship at Ruang Media Solusi, I developed a reporting website similar to lapor.go.id using Django, integrated 5+ API endpoints from a Laravel backend, and styled the frontend with Vuexy. I successfully completed 3 core modules (report submission, admin dashboard, user tracking) and improved API integration performance by ~20%.",
