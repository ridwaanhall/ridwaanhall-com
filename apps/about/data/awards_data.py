...
from apps.about.types import Award, IssuedDate
...
class AwardsData:
    awards = [
        asdict(Award(
            ...
            issued=IssuedDate(month="Feb", year=2020),
        ...
        asdict(Award(
            ...
            issued=IssuedDate(month="Mar", year=2020),
            institution="Islamic Boarding School of Al-Mukmin",
            website="https://almukminngruki.or.id/",
            logo=f"{settings.BASE_URL}/static/img/logo/al_mukmin_ngruki.webp",
        )),
        asdict(Award(
            ...
            issued=IssuedDate(month="Oct", year=2020),
            institution="Islamic Boarding School of Al-Mukmin",
            website="https://almukminngruki.or.id/",
            logo=f"{settings.BASE_URL}/static/img/logo/al_mukmin_ngruki.webp",
        )),
        asdict(Award(
            ...
            issued=IssuedDate(month="Jul", year=2024),
        ...
        asdict(Award(
            ...
            issued=IssuedDate(month="Aug", year=2024),
            institution="LinkedIn",
            website="https://www.linkedin.com/",
            logo=f"{settings.BASE_URL}/static/img/logo/linkedin.webp",
        )),
        asdict(Award(
            ...
            issued=IssuedDate(month="Oct", year=2024),
            institution="LinkedIn",
            website="https://www.linkedin.com/",
            logo=f"{settings.BASE_URL}/static/img/logo/linkedin.webp",
        )),
