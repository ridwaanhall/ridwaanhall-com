...
from apps.about.types import Certification, IssuedDate
...
class CertificationsData:
    certifications = [
        asdict(Certification(
            ...
            issued=IssuedDate(month="Jul", year=2025),
        ...
        asdict(Certification(
            ...
            issued=IssuedDate(month="Dec", year=2024),
        ...
        asdict(Certification(
            ...
            issued=IssuedDate(month="Nov", year=2024),
            institution="Dicoding Indonesia",
            website="https://www.dicoding.com",
            logo=f"{settings.BASE_URL}/static/img/logo/dicoding.webp",
            is_featured=False,
        ...
        asdict(Certification(
            ...
            issued=IssuedDate(month="Oct", year=2023),
            institution="LinkedIn Learning",
        ...
        asdict(Certification(
            ...
            issued=IssuedDate(month="Jun", year=2023),
        ...
        asdict(Certification(
            ...
            issued=IssuedDate(month="Jan", year=2023),
            institution="Altair RapidMiner",
            website="https://academy.rapidminer.com",
            logo=f"{settings.BASE_URL}/static/img/logo/rapidminer.webp",
            is_featured=False,
