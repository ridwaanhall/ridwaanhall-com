...
from apps.about.types import Experience, Period, PeriodDate
...
class ExperiencesData:
    ...
    experiences = [
        ...
        asdict(Experience(
            ...
            period=Period(
                start=PeriodDate(month="Jan", year=2023),
                end="Present",
            ),
        ...
        asdict(Experience(
            ...
            period=Period(
                start=PeriodDate(month="Sep", year=2021),
                end="Present",
            ),
        ...
        asdict(Experience(
            ...
            period=Period(
                start=PeriodDate(month="Feb", year=2025),
                end=PeriodDate(month="Jul", year=2025),
            ),
            employment_type=employment_types["pt"],
            location_type=location_types["rm"],
        ...
        asdict(Experience(
            ...
            website="https://go.dbs.com/dbsfcodingcamp",
            period=Period(
                start=PeriodDate(month="Dec", year=2024),
                end=PeriodDate(month="Jan", year=2025),
            ),
        ...
        asdict(Experience(
            ...
            website="https://go.dbs.com/dbsfcodingcamp",
            period=Period(
                start=PeriodDate(month="Oct", year=2024),
                end=PeriodDate(month="Dec", year=2024),
            ),
            employment_type=employment_types["sc"],
            location_type=location_types["rm"],
            location="Bandung, Indonesia 🇮🇩",
        ...
        asdict(Experience(
            ...
            website="https://go.dbs.com/dbsfcodingcamp",
            period=Period(
                start=PeriodDate(month="Jul", year=2024),
                end=PeriodDate(month="Sep", year=2024),
            ),
            employment_type=employment_types["sc"],
            location_type=location_types["rm"],
            location="Bandung, Indonesia 🇮🇩",
        ...
        asdict(Experience(
            ...
            website="https://go.dbs.com/dbsfcodingcamp",
            period=Period(
                start=PeriodDate(month="Jan", year=2024),
                end=PeriodDate(month="Jun", year=2024),
            ),
            employment_type=employment_types["sc"],
            location_type=location_types["rm"],
            location="Bandung, Indonesia 🇮🇩",
        ...
        asdict(Experience(
            ...
            period=Period(
                start=PeriodDate(month="Apr", year=2024),
                end=PeriodDate(month="May", year=2024),
            ),
            employment_type=employment_types["in"],
            location_type=location_types["rm"],
        ...
        asdict(Experience(
            ...
            website="https://gaotek.com",
            period=Period(
                start=PeriodDate(month="Feb", year=2024),
                end=PeriodDate(month="Mar", year=2024),
            ),
            employment_type=employment_types["in"],
            location_type=location_types["rm"],
            location="New York, USA 🇺🇸",
        ...
        asdict(Experience(
            ...
            period=Period(
                start=PeriodDate(month="Jan", year=2024),
                end=PeriodDate(month="Jan", year=2024),
            ),
            employment_type=employment_types["in"],
            location_type=location_types["rm"],
        ...
        asdict(Experience(
            ...
            period=Period(
                start=PeriodDate(month="Sep", year=2019),
                end=PeriodDate(month="Sep", year=2020),
            ),
