...
class AboutData:
    ...
    def get_about_data(cls):
        return {
            ...
            "stories": [
                "I am Ridwan, known as ridwaanhall or roneha. A Python developer with a passion for web development and machine learning from Central Java, Indonesia, I lead Copilot ID—my creative hub for building intelligent systems and web applications with Django, Flask, and AI tools with PyTorch, and TensorFlow, crafting each project with purpose.",
