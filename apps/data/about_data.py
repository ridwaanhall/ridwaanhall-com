        ...
        return [
            {
                ...
                "stories": [
                    "Hi, I'm <span class='font-bold text-blue-600 dark:text-blue-400'>Ridwan Halim</span>—a <span class='font-semibold text-green-600'>Python Developer</span>, <span class='font-semibold text-indigo-600'>Machine Learning Mentor</span>, and Founder of Copilot ID based in the vibrant city of Special Region of Yogyakarta, Indonesia. I'm passionate about building AI-powered solutions and crafting awesome web applications.",
                    "On a personal note, I've memorized nearly <span class='font-semibold text-amber-600'>30 Juz of the Quran</span>, an achievement that taught me the values of discipline, dedication, and focus—qualities I bring to every aspect of my professional life.",
                    "Professionally, I've had the chance to take on some exciting roles. As a <span class='font-semibold text-indigo-600'>Machine Learning mentor</span> at Coding Camp powered by DBS Foundation, I've guided over 50 students to master both technical and soft skills. I've also completed more than <span class='font-semibold text-green-600'>30 Python projects</span> using technologies like Django, Flask, TensorFlow, PyTorch, and Next.js.",
                    ...
                    "My educational journey includes earning a bachelor's degree in <span class='font-semibold text-purple-600'>Intelligent Systems (AI)</span> from the University of Technology Yogyakarta, where I focused on advancing Machine Learning technologies. Before that, I studied at Pondok Pesantren Islam Al Mukmin, where I built a strong foundation in Islamic studies while attending Islamic Boarding School of Al Mukmin.",
                    "Looking ahead, my vision is to leverage <span class='font-semibold text-blue-600'>AI</span> to solve real-world problems quickly and efficiently. I'm also passionate about building my personal brand, contributing to open-source projects, and focusing on both short and long-term investments to support sustainable growth and innovation.",
