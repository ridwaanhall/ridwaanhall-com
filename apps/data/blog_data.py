    ...
    blogs = [
        {
            ...
            "date_in_rfc": datetime.strptime("2025-03-24T00:00:00+07:00", "%Y-%m-%dT%H:%M:%S%z"),
            "author": "Ridwan Halim",
        ...
        },
        {
            ...
            "date_in_rfc": datetime.strptime("2025-03-27T00:00:00+07:00", "%Y-%m-%dT%H:%M:%S%z"),
            "author": "Ridwan Halim",
            "username": "ridwaanhall",
            "author_image": f"{settings.BASE_URL}/static/img/ridwaanhall.webp",
            "content": [
        ...
        },
        {
            ...
            "date_in_rfc": datetime.strptime("2025-03-28T00:00:00+07:00", "%Y-%m-%dT%H:%M:%S%z"),
            "author": "Ridwan Halim",
            "username": "ridwaanhall",
            "author_image": f"{settings.BASE_URL}/static/img/ridwaanhall.webp",
            "content": [
        ...
        },
        {
            ...
            "date_in_rfc": datetime.strptime("2025-03-31T00:00:00+07:00", "%Y-%m-%dT%H:%M:%S%z"),
            "author": "Ridwan Halim",
            "username": "ridwaanhall",
            "author_image": f"{settings.BASE_URL}/static/img/ridwaanhall.webp",
            "content": [
        ...
        },
        {
            ...
            "date_in_rfc": datetime.strptime("2025-04-04T00:00:00+07:00", "%Y-%m-%dT%H:%M:%S%z"),
            "author": "Ridwan Halim",
            "username": "ridwaanhall",
            "author_image": f"{settings.BASE_URL}/static/img/ridwaanhall.webp",
            "is_featured": True,
        ...
        },
        {
            ...
            "date_in_rfc": datetime.strptime("2025-04-13T00:00:00+07:00", "%Y-%m-%dT%H:%M:%S%z"),
            "author": "Ridwan Halim",
            "username": "ridwaanhall",
            "author_image": f"{settings.BASE_URL}/static/img/ridwaanhall.webp",
            "content": [
        ...
        },
        {
            ...
            "date_in_rfc": datetime.strptime("2025-04-16T00:00:00+07:00", "%Y-%m-%dT%H:%M:%S%z"),
            "author": "Ridwan Halim",
            "username": "ridwaanhall",
            "author_image": f"{settings.BASE_URL}/static/img/ridwaanhall.webp",
            "content": [
