...
class BlogData:
    ...
    blogs = [
        ...
        },
        {
            ...
            "author_image": f"{settings.BASE_URL}/static/img/ridwaanhall.webp",
            "content": [
                "<h2 class='text-xl md:text-2xl lg:text-3xl font-bold mt-4 md:mt-5 mb-2 md:mb-3'>The Importance of Domain Selection: More Than Just a Web Address</h2>",
                ...
                "<h2 class='text-xl md:text-2xl lg:text-3xl font-bold mt-4 md:mt-5 mb-2 md:mb-3'>Domain Name Selection Criteria: What Really Matters</h2>",
                ...
                "<h2 class='text-xl md:text-2xl lg:text-3xl font-bold mt-4 md:mt-5 mb-2 md:mb-3'>Key Takeaways for Domain Selection</h2>",
        ...
        },
        {
            ...
            "content": [
                ...
                "<h2 class='text-xl md:text-2xl lg:text-3xl font-bold mt-4 md:mt-5 mb-2 md:mb-3'>From Islamic Boarding School to Programming</h2>",
                ...
                "<h2 class='text-xl md:text-2xl lg:text-3xl font-bold mt-4 md:mt-5 mb-2 md:mb-3'>Gaza's Reality: Facts and Figures</h2>",
                ...
                "<h2 class='text-xl md:text-2xl lg:text-3xl font-bold mt-4 md:mt-5 mb-2 md:mb-3'>Using Django to Spread Awareness</h2>",
                ...
                "<h2 class='text-xl md:text-2xl lg:text-3xl font-bold mt-4 md:mt-5 mb-2 md:mb-3'>How You Can Help</h2>",
