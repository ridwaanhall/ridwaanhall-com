...
# Blog data for: Why mlbb-stats.ridwaanhall.com and api-pddikti.kemdiktisaintek.go.id Go Offline Soon
blog_data = {
    "id": 17,
    "title": """Why mlbb-stats.ridwaanhall.com and api-pddikti.kemdiktisaintek.go.id Go Offline Soon""",
    ...
    "image_url": f"{settings.BLOG_BASE_IMG_URL}/api_shutdown_notice.webp",
    "img_name": "api_shutdown_notice.webp",
    "created_at": datetime.strptime("2025-07-05T02:53:00+07:00", "%Y-%m-%dT%H:%M:%S%z"),
    "updated_at": datetime.strptime("2025-07-05T02:53:00+07:00", "%Y-%m-%dT%H:%M:%S%z"),
    "author": "Ridwan Halim",
    "username": "ridwaanhall",
    "author_image": f"{settings.BASE_URL}/static/img/ridwaanhall.webp",
    "content": [
        "<p class='mb-2 text-sm md:text-base lg:text-lg'>In the spirit of open data and community innovation, two API services—<strong>mlbb-stats.ridwaanhall.com</strong> and <strong>api-pddikti.kemdiktisaintek.go.id</strong>—were created to empower developers, researchers, and educators across Indonesia and beyond.</p>",
        ...
        "<p class='mb-2 text-sm md:text-base lg:text-lg'>Starting <strong>July 5, 2025</strong>, <code>mlbb-stats.ridwaanhall.com</code> is scheduled to go offline. Just days later, on <strong>July 10, 2025</strong>, <code>api-pddikti.kemdiktisaintek.go.id</code> may follow suit. The reason is simple: growing traffic demands higher server costs—and right now, there is no financial support sustaining these services.</p>",
    ...
    "read_time": 3,
    "views": 0,
    "slug": "why-mlbb-stats-ridwaanhall-com-and-api-pddikti-kemdiktisaintek-go-id-go-offline-soon"
}
