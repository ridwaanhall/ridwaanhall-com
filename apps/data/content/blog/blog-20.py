...
blog_data = {
    ...
    # =========================
    "description": (
        "A practical guide to writing expressive and consistent commit messages using emojis, "
        "types, scopes, and summaries. This format improves readability, collaboration, and "
    ...
    "content": [
        {
            ...
            "text": (
                "Commit messages are more than just notes—they are a communication tool. "
                "By using emojis and a consistent format, teams can quickly understand the "
                "purpose of each commit while keeping the history fun and easy to scan."
            )
        },
        {
            "type": "p",
            "class": "mb-2 text-sm md:text-base lg:text-lg",
            "text": "We follow this pattern for commit messages:"
        },
        {
            "type": "code",
            "class": "mb-4 text-sm md:text-base lg:text-lg",
            "text": "[emoji][type](scope): summary"
        },
        {
            "type": "table",
            "class": "mb-4 text-sm md:text-base lg:text-lg",
            "headers": ["Emoji", "Type", "Tagline", "Example"],
            "rows": [
        ...
        },
        {
            ...
            "class": "mb-2 text-sm md:text-base lg:text-lg",
            "text": (
                "This style guide ensures that commit history remains structured and expressive. "
                "Each emoji provides instant context, while the type and scope clarify the exact purpose."
            )
        },
    ]
}
