...
project_data = asdict(ProjectData(
    ...
    features=[
        Feature(title='RNN Powerhouse', description='LSTM and GRU models crush it at capturing time-based patterns.'),
        Feature(title='Loaded Dataset', description='Blends historical demand, weather, and calendar data for sharp predictions.'),
    ...
    tags=['RNN', 'LSTM', 'GRU', 'Electricity Demand', 'Forecasting', 'Time Series', 'Energy Management', 'Python', 'PyTorch', 'Weather Data'],
    is_featured=False,
