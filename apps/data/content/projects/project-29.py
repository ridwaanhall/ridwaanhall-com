...
project_data = asdict(ProjectData(
    ...
    features=[
        Feature(title='Session Coordinator', description='Manages Mabar sessions with donor and user details.'),
        Feature(title='Skin Request Flow', description='Automates skin delivery status for VIPs.'),
        Feature(title='Hero Pick System', description='Handles hero preferences, lanes, and meta choices.'),
    ...
    tags=['MLBB', 'Mobile Legends', 'VIP Management', 'Mabar Organizer', 'Django', 'Python', 'Gaming', 'Session Management', 'Skin Requests', 'Hero Picks'],
    is_featured=False,
