...
project_data = {
    ...
    "tech_stack": [{'name': 'Python', 'description': 'My go-to for building robust backends with clean code', 'icon_svg': 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg'}, {'name': 'Streamlit', 'description': 'Turns Python into slick data dashboards and apps', 'icon_svg': 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/streamlit/streamlit-original.svg'}, {'name': 'TensorFlow', 'description': 'My toolkit for diving deep into ML and neural networks', 'icon_svg': 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tensorflow/tensorflow-original.svg'}],
