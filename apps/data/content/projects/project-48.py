...
project_data = {
    ...
    "features": [
        {
            "title": "Smart Draft Picks",
            "description": "Pinpoint heroes that synergize or counter with precision."
        },
        {
            "title": "Flexible Input",
            "description": "Supports case-insensitive hero names and IDs with relaxed formatting."
        },
        {
            "title": "Speedy Predictions",
            "description": "Trained once, reused often. Fast suggestions in every draft."
        }
    ],
    "images": {
