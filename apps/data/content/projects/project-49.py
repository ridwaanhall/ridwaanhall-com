...
project_data = {
    ...
    "features": [
        {
            "title": "OOP vs non-OOP Simulation",
            "description": "The `perintis` branch uses OOP to build a new foundation, while `pewaris` continues the existing system procedurally."
        },
        {
            "title": "Struggle Narrative",
            "description": "Python functions illustrate the journey, failures, and victories in a social and personal context."
        },
        {
            "title": "Simple API",
            "description": "FastAPI endpoint to generate the struggle narrative dynamically and contextually."
        }
    ],
    "images": {
