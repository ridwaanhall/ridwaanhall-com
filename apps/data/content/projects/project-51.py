...
project_data = {
    ...
    "is_featured": False,
    "features": [
        {'title': 'Dataset Processor', 'description': 'Downloads and prepares the Rock-Paper-Scissors dataset with validation split and augmentation.'},
        {'title': 'Model Builder', 'description': 'Defines and trains a CNN model with dropout and softmax output for gesture classification.'},
        {'title': 'Training History Plot', 'description': 'Visualizes accuracy and loss trends across 75 epochs.'},
        {'title': 'Image Predictor', 'description': 'Predicts uploaded image class using the trained model and displays results with matplotlib.'},
        {'title': 'Performance Metrics', 'description': 'Achieves 99.22% validation accuracy with low loss, ensuring robust classification.'}
    ],
    "tech_stack": [
