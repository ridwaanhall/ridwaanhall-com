...
project_data = {
    ...
    "tech_stack": [{'name': 'Python', 'description': 'My go-to for building robust backends with clean code', 'icon_svg': 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg'}, {'name': 'HOG', 'description': 'Histogram of Oriented Gradients for object detection'}, {'name': 'SVM', 'description': 'Support Vector Machines for classification and regression tasks'}, {'name': 'KNN', 'description': 'K-Nearest Neighbors for classification based on distance metrics'}],
