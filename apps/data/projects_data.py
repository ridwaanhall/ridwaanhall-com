            ...
            "features": [
                {
                    ...
                    "description": "Gold prices updated on the regular to keep you in sync with the market."
                },
                {
                    "title": "Throwback Trends",
                    "description": "Deep dive into past price action across different timeframes."
                },
                {
                    "title": "Smart Analytics",
                    "description": "SMA calculations and volatility insights to keep it 100."
                }
            ],
            "tech_stack": [
                tech_stack["python"],
