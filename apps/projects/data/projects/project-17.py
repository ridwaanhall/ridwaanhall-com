...
project_data = asdict(ProjectData(
    ...
    features=[
        Feature(title='Task-Targeted APIs', description='Query weather or author data with built-in functions.'),
        Feature(title='Smooth Connect', description='Python’s requests library links up with OpenAI flawlessly.'),
        Feature(title='Text Powerhouse', description='GPT-3.5 Turbo delivers smart, spot-on responses.'),
    ],
    images={
    ...
    tags=['OpenAI', 'GPT-3.5 Turbo', 'API', 'NLP', 'Flask', 'Python', 'Function Calling', 'Text Processing'],
    is_featured=False,
