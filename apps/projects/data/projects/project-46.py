...
project_data = asdict(ProjectData(
    ...
    github_url='https://github.com/ridwaanhall/HargaEmas',
    demo_url='https://harga-emas.rone.dev',
    category='finance',
    ...
    updated_at=datetime.strptime("2026-03-01T20:18:00+07:00", "%Y-%m-%dT%H:%M:%S%z"),
))
