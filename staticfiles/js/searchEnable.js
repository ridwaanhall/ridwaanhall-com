document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateButtonState() {
        ...
        if (hasValue) {
            searchButton.className = "inline-flex items-center justify-center px-3 py-2 rounded-md border border-zinc-700 bg-zinc-800 hover:border-zinc-400 hover:bg-zinc-900 transition-all duration-300 text-sm font-semibold h-full whitespace-nowrap cursor-pointer";
        } else {
